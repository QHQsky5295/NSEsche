...
ROOT = Path(
    "tmp/nse_e3_causal_raw_persistence_route_native_frontier_training_20260831_v147"
)
PLAN = Path(
    "scripts/reviewer_experiments/protocol/"
    "nse_e3_causal_raw_persistence_route_native_frontier_training_plan_v147.json"
)
PLAN_SHA256 = "531eb1d788bf5d05cf37736b7652710217f4f6f226caeec86ce12d36b02b765f"
...
V146_PLAN_SHA256 = "e7f8b834db77a5438bd0b1308260a9b82a96e7b96876977627f5d36c3b7835a9"
V146_INVALIDATION = Path(
    "scripts/reviewer_experiments/protocol/"
    "nse_e3_causal_raw_persistence_full_frontier_router_reference_invalidation_v146.json"
)
V146_INVALIDATION_SHA256 = (
    "a6d062d5ba36ada12e3bedf53f27696cc6e86d33d9ff19519f21470df3359bfe"
)
V146_INVALIDATION_HASH = (
    "eea99e2b9abf27dc283d7e79e5e5c320936a3c4578b09271acf4f2d63b83efbb"
)

BINARY_PATH = Path("tmp/nse_v147_build_4ddbfcc/release/serverless_sim.exe")
BINARY_SHA256 = "9a935795b75acb34210c42b44a47335933e589324efae3bd57c4540a907457e5"
BINARY_SOURCE_COMMIT = "4ddbfcc648339676465d1a12fdf1a6cb60c3e215"
V147_REVISION = "raw_persistence_route_native_frontier_v1"

ARM_ID = "v147-e3-causal-raw-persistence-route-native-frontier-nash"
PROFILE = "causal_raw_persistence_route_native_frontier_greedy_faasrank_loadleast_nash"
...
RUN_ORDER_SEED = "NSE-V147-ROUTE-NATIVE-FRONTIER-E1526-E1528"
PORT = "3177"
...
PLAYER_FRONTIER = "route_selected_native_frontier"
ROUTE_FRONTIERS = {
    "greedy": "all_unscheduled_functions",
    "faasrank": "parents_completed",
    "load_least": "all_unscheduled_functions",
}
V147_SERVICE_STATE_DOMAIN = "runtime_existing_aggregates_and_admitted_work"
...
def paths(root: Path = ROOT) -> dict[str, Path]:
    return {
        ...
        "schedule": root / "frozen-run-order-v147.json",
    }
...
def _assert_frozen_inputs() -> None:
    frozen = (
        ...
        (V146_PLAN, V146_PLAN_SHA256),
        (V146_INVALIDATION, V146_INVALIDATION_SHA256),
    ...
    for path, expected in frozen:
        if not path.is_file() or file_hash(path).lower() != expected.lower():
            raise RuntimeError(f"frozen V147 input is missing or changed: {path}")
    ...
    v146_invalidation = _assert_hashed(
        V146_INVALIDATION, "invalidation_hash", V146_INVALIDATION_HASH
    )
    for label, result in (
        ("V142", v142_result),
        ("V143", v143_result),
    ...
    if (
        v146_invalidation.get("status") != "retired_before_online_candidate_execution"
        or v146_invalidation.get("online_candidate_runs_started") != 0
        or v146_invalidation.get("performance_summaries_parsed") != 0
        or v146_invalidation.get("disposition", {}).get("v146_retired") is not True
    ):
        raise RuntimeError("V146 reference-integrity invalidation changed")
...
def _rewrite_candidate(template: dict[str, Any]) -> dict[str, Any]:
    ...
    marker.update(
        {
            "purpose": f"V147 {ARM_ID} {PLAN_SHA256}",
            "v147_role": "adaptive_training_candidate",
            "v147_training_plan_sha256": PLAN_SHA256,
            "v147_binary_source_commit": BINARY_SOURCE_COMMIT,
            "v147_revision": V147_REVISION,
            "v147_parent_v144_plan_sha256": V144_PLAN_SHA256,
            "v147_parent_v144_blind_sha256": V144_BLIND_SHA256,
            "v147_parent_v144_result_sha256": V144_RESULT_SHA256,
            "v147_parent_v145_plan_sha256": V145_PLAN_SHA256,
            "v147_parent_v145_blind_sha256": V145_BLIND_SHA256,
            "v147_parent_v145_result_sha256": V145_RESULT_SHA256,
            "v147_parent_v146_plan_sha256": V146_PLAN_SHA256,
            "v147_parent_v146_invalidation_sha256": V146_INVALIDATION_SHA256,
            "v147_parent_v146_invalidation_hash": V146_INVALIDATION_HASH,
            "v147_arm_id": ARM_ID,
            "v147_profile": PROFILE,
            "v147_native_selection_rule": SELECTION_RULE,
            "v147_native_portfolio_members": NATIVE_MEMBERS,
            "v147_runtime_native_kind_order": RUNTIME_NATIVE_KINDS,
            "v147_shock_threshold_numerator": SHOCK_THRESHOLD_NUMERATOR,
            "v147_shock_threshold_denominator": SHOCK_THRESHOLD_DENOMINATOR,
            "v147_shock_baseline_frames": SHOCK_BASELINE_FRAMES,
            "v147_shock_recent_frames": SHOCK_RECENT_FRAMES,
            "v147_shock_active_frames": SHOCK_ACTIVE_FRAMES,
            "v147_persistence_baseline_frames": PERSISTENCE_BASELINE_FRAMES,
            "v147_persistence_recent_frames": PERSISTENCE_RECENT_FRAMES,
            "v147_persistence_evaluation_age_frames": PERSISTENCE_EVALUATION_AGE_FRAMES,
            "v147_persistence_threshold_numerator": PERSISTENCE_THRESHOLD_NUMERATOR,
            "v147_persistence_threshold_denominator": PERSISTENCE_THRESHOLD_DENOMINATOR,
            "v147_expert_lifecycle": EXPERT_LIFECYCLE,
            "v147_player_frontier": PLAYER_FRONTIER,
            "v147_route_frontiers": ROUTE_FRONTIERS,
            "v147_single_factor_change": "universal_all_unscheduled_to_route_selected_expert_native_frontier",
            "v147_native_frontier_command_evidence_required": True,
            "v147_expected_run_count": 9,
            "v147_expected_reference_count": 9,
            "v147_reused_v142_baseline_runs": 81,
            "v147_baseline_rerun_count": 0,
            "v147_performance_results_consulted_for_mechanism_design": True,
            "v147_candidate_performance_summaries_parsed": 0,
            "v147_confirmation_inputs_opened": False,
        ...
        metadata.update(
            {
                ...
                "v147_parent_v146_invalidation_sha256": V146_INVALIDATION_SHA256,
                "v147_parent_v146_invalidation_hash": V146_INVALIDATION_HASH,
                "v147_training_only": True,
                "v147_role": "adaptive_training_candidate",
                "v147_arm_id": ARM_ID,
                "v147_profile": PROFILE,
                "v147_native_selection_rule": SELECTION_RULE,
                "v147_native_portfolio_members": NATIVE_MEMBERS,
                "v147_source_v142_run_id": source_run_id,
                "v147_source_v142_run_spec_hash": source_run_spec_hash,
                "v147_expert_lifecycle": EXPERT_LIFECYCLE,
                "v147_player_frontier": PLAYER_FRONTIER,
                "v147_route_frontiers": ROUTE_FRONTIERS,
                "v147_single_factor_change": "universal_all_unscheduled_to_route_selected_expert_native_frontier",
                "v147_native_frontier_command_evidence_required": True,
                "v147_all_three_experts_advanced_every_window": True,
                "v147_shock_detector": "first_seen_arrivals_80_frame_baseline_20_frame_recent_3_over_2_threshold_50_frame_latch_for_episode_onset_only",
                "v147_persistence_test": "freeze_preceding80_raw_arrivals_at_first_onset_then_at_age55_compare_recent5_mean_to_3_over_2_baseline_mean_once_with_checked_integer_arithmetic",
                "v147_quiet_route": "greedy",
                "v147_first_short_route": "greedy",
                "v147_first_sustained_route": "faasrank",
                "v147_recurrent_route": "load_least",
                "v147_complete_native_assignments_required": True,
                "v147_service_certificate_scope": SERVICE_CERTIFICATE_SCOPE,
                "v147_service_certificate_state_domain": V147_SERVICE_STATE_DOMAIN,
                "v147_paper_welfare_state_domain": V147_WELFARE_STATE_DOMAIN,
                "v147_no_numeric_tuning": True,
                "v147_outcome_fields_drive_policy": False,
                "v147_scenario_or_burst_label_used_by_policy": False,
                "v147_future_arrivals_used_by_policy": False,
                "v147_adaptive_training_reuses_v142_results": True,
                "v147_confirmation_inputs_opened": False,
            }
        )
...
def _validate_product(manifest: dict[str, Any]) -> None:
    ...
    if len(runs) != 9 or actual != expected:
        raise RuntimeError("V147 scenario/seed product changed")
    if {run["method"] for run in runs} != {"sche_nash"}:
        raise RuntimeError("V147 method product changed")
    if len(manifest["reference_build_dependencies"]) != 9:
        raise RuntimeError("V147 reference product changed")
    if any(
        run["environment"].get("NASH_OPERATIONAL_EXPERT_PROXY") != PROFILE
        or run.get("metadata", {}).get("v147_native_portfolio_members")
        != NATIVE_MEMBERS
        or run.get("metadata", {}).get("v147_all_three_experts_advanced_every_window")
        is not True
        or run.get("metadata", {}).get("v147_quiet_route") != "greedy"
        or run.get("metadata", {}).get("v147_persistence_test")
        ...
        or run.get("metadata", {}).get("v147_player_frontier") != PLAYER_FRONTIER
        or run.get("metadata", {}).get("v147_route_frontiers") != ROUTE_FRONTIERS
        or run.get("metadata", {}).get("v147_single_factor_change")
        != "universal_all_unscheduled_to_route_selected_expert_native_frontier"
        or run.get("metadata", {}).get("v147_native_frontier_command_evidence_required")
        is not True
        or run.get("metadata", {}).get("v147_confirmation_inputs_opened") is not False
        for run in runs
    ):
        raise RuntimeError("V147 candidate contract changed")
...
def _frozen_schedule(manifest: dict[str, Any]) -> dict[str, Any]:
    ...
    document = {
        "schema_version": "NSE_E3_CAUSAL_RAW_PERSISTENCE_ROUTE_NATIVE_FRONTIER_RUN_ORDER_V147_V1",
        "created_at": utc_now(),
...
def prepare_v147(root: Path = ROOT) -> dict[str, Any]:
    _assert_frozen_inputs()
    if root.exists():
        raise RuntimeError(f"refusing to overwrite V147 training root: {root}")
    ...
    receipt = {
        "schema_version": "NSE_E3_CAUSAL_RAW_PERSISTENCE_ROUTE_NATIVE_FRONTIER_PREPARED_V147_V1",
        "created_at": utc_now(),
        ...
        "v146_plan_path": str(V146_PLAN),
        "v146_plan_file_sha256": V146_PLAN_SHA256,
        "v146_invalidation_path": str(V146_INVALIDATION),
        "v146_invalidation_file_sha256": V146_INVALIDATION_SHA256,
        "v146_invalidation_hash": V146_INVALIDATION_HASH,
        "parent_disposition": "V146_retired_before_online_execution_after_all_nine_reference_dependencies_blocked",
        "v147_revision": V147_REVISION,
