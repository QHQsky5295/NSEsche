...
def _critical(
    ...
    return {
        ...
        "service_directed_construction": {
            ...
            "choice_rule": "existing_v113_admitted_work_service_choice_with_frozen_ratio_and_safety_filters",
        ...
        "complete_componentwise_pareto": {
            ...
            "comparison": "every_current_player_alternative_less_than_or_equal_to_anchor",
...
class AllPlayerServiceBlindAuditV119Tests(unittest.TestCase):
    def test_frozen_arm_seed_and_runtime_boundary(self) -> None:
        self.assertEqual(TRAINING_SEEDS, {"E926", "E927", "E928"})
