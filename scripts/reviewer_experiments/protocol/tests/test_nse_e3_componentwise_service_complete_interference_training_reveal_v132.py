...
import scripts.reviewer_experiments.protocol.nse_e3_componentwise_service_complete_interference_training_reveal_v132 as reveal_module
from scripts.reviewer_experiments.protocol.nse_e3_componentwise_service_complete_interference_training_reveal_v132 import (
    ARMS,
    CANDIDATE_ID,
    EXPECTED_SCENARIOS,
    EXPECTED_SEEDS,
...
class ComponentwiseServiceCompleteInterferenceRevealV132Tests(unittest.TestCase):
    def test_reveal_is_locked_to_the_frozen_joint_blind_audit(self) -> None:
        ...
        self.assertEqual(
            ...
            "3ed824e37a5f61a7b5d44e4d2ad244dd25cc354e3862f0faa0bd9076f3c9511f",
        )
    ...
    def test_single_candidate_must_pass_all_nine_frozen_gates(self) -> None:
        ...
        self.assertFalse(diagnostic["used_for_V132_selection"])
    ...
    def test_one_large_outlier_cannot_satisfy_two_of_three_rule(self) -> None:
        ...
        for row in rows:
            if row["arm_id"] == CANDIDATE_ID and row["scenario_id"] == "E3.spike5x50ms":
                value = 10.0 if row["seed"] == "E1381" else 0.9
