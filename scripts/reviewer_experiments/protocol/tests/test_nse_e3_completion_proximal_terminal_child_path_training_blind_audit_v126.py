...
class CompletionProximalBlindAuditV126Tests(unittest.TestCase):
    def test_frozen_arm_seed_and_runtime_boundary(self) -> None:
        self.assertEqual(TRAINING_SEEDS, {"E1241", "E1242", "E1243"})
        self.assertEqual(CONFIRMATION_SEEDS, [f"E{i}" for i in range(1244, 1264)])
        self.assertEqual(
