...
import scripts.reviewer_experiments.protocol.nse_e3_completion_proximal_terminal_child_hpa_path_training_reveal_v127 as reveal_module
from scripts.reviewer_experiments.protocol.nse_e3_completion_proximal_terminal_child_hpa_path_training_reveal_v127 import (
    ARMS,
    CANDIDATE_ID,
    EXPECTED_SCENARIOS,
    EXPECTED_SEEDS,
...
class CompletionProximalRevealV127Tests(unittest.TestCase):
    def test_reveal_is_locked_to_the_frozen_joint_blind_audit(self) -> None:
        ...
        self.assertEqual(
            ...
            "4e4c057eff94859304b86e07678bc93dfa8cf39619f706af7002ee9c6b3a37c7",
        )
        self.assertEqual(reveal_module.EXPECTED_SEEDS, ("E1264", "E1265", "E1266"))
    ...
    def test_single_candidate_must_pass_all_nine_frozen_gates(self) -> None:
        ...
        self.assertFalse(diagnostic["used_for_V127_selection"])
