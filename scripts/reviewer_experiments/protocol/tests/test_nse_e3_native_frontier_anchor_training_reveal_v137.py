...
from scripts.reviewer_experiments.protocol.nse_e3_native_frontier_anchor_training_reveal_v137 import (
    METRICS,
...
class NativeFrontierAnchorRevealV137Tests(unittest.TestCase):
