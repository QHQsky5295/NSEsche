...
import scripts.reviewer_experiments.protocol.nse_e3_load_initializer_certificate_factorial_training_reveal_v102 as reveal_module
from scripts.reviewer_experiments.protocol.nse_e3_load_initializer_certificate_factorial_training_reveal_v102 import (
    ARMS,
    EXPECTED_SCENARIOS,
    EXPECTED_SEEDS,
...
class LoadInitializerCertificateFactorialRevealV102Tests(unittest.TestCase):
    ...
    def test_joint_gate_uses_frozen_conditional_certificate_tie_break(self) -> None:
        ...
        self.assertFalse(diagnostic["used_for_V102_selection"])
    ...
    def test_one_large_outlier_cannot_satisfy_two_of_three_rule(self) -> None:
        ...
        for row in rows:
            if (
                ...
                value = 10.0 if row["seed"] == "E877" else 0.9
