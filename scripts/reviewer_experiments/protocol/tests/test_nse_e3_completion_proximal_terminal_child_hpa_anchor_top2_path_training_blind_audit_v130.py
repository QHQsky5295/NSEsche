...
def _critical(invoked: bool, *, work_source: str) -> dict:
    return {
        ...
        "terminal_child_path_pareto": {
            ...
            "comparison": "every_terminal_child_alternative_path_to_each_of_the_first_two_deterministic_anchor_ranked_hpa_containers_less_than_or_equal_to_anchor",
            ...
            "container_pairing": "same_first_two_deterministic_anchor_ranked_child_container_nodes",
            "aggregation": "complete_per_child_pareto_on_up_to_two_deterministic_anchor_ranked_witnesses",
...
class CompletionProximalBlindAuditV130Tests(unittest.TestCase):
    def test_frozen_arm_seed_and_runtime_boundary(self) -> None:
        self.assertEqual(TRAINING_SEEDS, {"E1333", "E1334", "E1335"})
        self.assertEqual(CONFIRMATION_SEEDS, [f"E{i}" for i in range(1336, 1356)])
        self.assertEqual(
            PREVIOUS_CONFIRMATION_SEEDS,
            [
