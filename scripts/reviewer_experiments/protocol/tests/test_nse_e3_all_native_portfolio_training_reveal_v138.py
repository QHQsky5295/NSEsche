...
from scripts.reviewer_experiments.protocol import (
    nse_e3_all_native_portfolio_training_reveal_v138 as reveal_v138,
)
...
from scripts.reviewer_experiments.protocol.nse_e3_all_native_portfolio_training_reveal_v138 import (
    METRICS,
...
class AllNativePortfolioRevealV138Tests(unittest.TestCase):
    ...
    def test_reveal_remains_sealed_until_this_rounds_blind_hash_is_frozen(self) -> None:
        self.assertIsNone(reveal_v138.BLIND_AUDIT_FILE_SHA256)
        self.assertIsNone(reveal_v138.BLIND_AUDIT_HASH)
        with self.assertRaisesRegex(RuntimeError, "has not been frozen"):
            reveal_v138._validate_blind_audit()
