...
import scripts.reviewer_experiments.protocol.nse_e3_critical_service_time_training_reveal_v108 as reveal_module
from scripts.reviewer_experiments.protocol.nse_e3_critical_service_time_training_reveal_v108 import (
    ARMS,
    EXPECTED_SCENARIOS,
    EXPECTED_SEEDS,
...
class CriticalServiceTimeRevealV108Tests(unittest.TestCase):
    ...
    def test_joint_gate_uses_frozen_stricter_service_proxy_tie_break(self) -> None:
        ...
        self.assertFalse(diagnostic["used_for_V108_selection"])
    ...
    def test_one_large_outlier_cannot_satisfy_two_of_three_rule(self) -> None:
        ...
        for row in rows:
            if (
                ...
                value = 10.0 if row["seed"] == "E895" else 0.9
