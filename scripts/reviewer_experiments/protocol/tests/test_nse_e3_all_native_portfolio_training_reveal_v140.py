...
from scripts.reviewer_experiments.protocol import (
    nse_e3_all_native_portfolio_training_reveal_v140 as reveal_v140,
)
...
from scripts.reviewer_experiments.protocol.nse_e3_all_native_portfolio_training_reveal_v140 import (
    METRICS,
...
class AllNativePortfolioRevealV140Tests(unittest.TestCase):
