...
import scripts.reviewer_experiments.protocol.nse_e3_completion_proximal_componentwise_training_reveal_v124 as reveal_module
from scripts.reviewer_experiments.protocol.nse_e3_completion_proximal_componentwise_training_reveal_v124 import (
    ARMS,
    CANDIDATE_ID,
    EXPECTED_SCENARIOS,
    EXPECTED_SEEDS,
...
class CompletionProximalRevealV124Tests(unittest.TestCase):
    def test_reveal_is_locked_to_the_frozen_joint_blind_audit(self) -> None:
        ...
        self.assertEqual(
            ...
            "8843d0a8096de839217454efcabc56cd661db7c323ca1a1e892f92f6faa32fd2",
        )
    ...
    def test_single_candidate_must_pass_all_nine_frozen_gates(self) -> None:
        ...
        self.assertFalse(diagnostic["used_for_V124_selection"])
