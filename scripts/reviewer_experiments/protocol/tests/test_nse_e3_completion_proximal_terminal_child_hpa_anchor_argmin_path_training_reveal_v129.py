...
import scripts.reviewer_experiments.protocol.nse_e3_completion_proximal_terminal_child_hpa_anchor_argmin_path_training_reveal_v129 as reveal_module
from scripts.reviewer_experiments.protocol.nse_e3_completion_proximal_terminal_child_hpa_anchor_argmin_path_training_reveal_v129 import (
    ARMS,
    CANDIDATE_ID,
    EXPECTED_SCENARIOS,
    EXPECTED_SEEDS,
...
class CompletionProximalRevealV129Tests(unittest.TestCase):
    def test_reveal_remains_locked_until_the_v129_joint_blind_audit_is_frozen(
        self,
    ) -> None:
        self.assertEqual(
            reveal_module.BLIND_AUDIT_FILE_SHA256,
            "__FREEZE_AFTER_V129_BLIND_AUDIT__",
        )
        self.assertEqual(
            reveal_module.BLIND_AUDIT_HASH,
            "__FREEZE_AFTER_V129_BLIND_AUDIT__",
        )
        self.assertEqual(reveal_module.EXPECTED_SEEDS, ("E1310", "E1311", "E1312"))
    ...
    def test_single_candidate_must_pass_all_nine_frozen_gates(self) -> None:
        ...
        self.assertFalse(diagnostic["used_for_V129_selection"])
