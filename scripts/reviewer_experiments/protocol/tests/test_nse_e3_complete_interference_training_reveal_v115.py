...
import scripts.reviewer_experiments.protocol.nse_e3_complete_interference_training_reveal_v115 as reveal_module
from scripts.reviewer_experiments.protocol.nse_e3_complete_interference_training_reveal_v115 import (
    ARMS,
    CANDIDATE_ID,
    EXPECTED_SCENARIOS,
    EXPECTED_SEEDS,
...
class CompleteInterferenceRevealV115Tests(unittest.TestCase):
    def test_reveal_is_locked_to_the_frozen_joint_blind_audit(self) -> None:
        ...
        self.assertEqual(
            ...
            "3b45843a7046a82c49d7339119262957c5633530ceae0fb3b8fea99371d78989",
        )
    ...
    def test_single_candidate_must_pass_all_nine_frozen_gates(self) -> None:
        ...
        self.assertFalse(diagnostic["used_for_V115_selection"])
    ...
    def test_one_large_outlier_cannot_satisfy_two_of_three_rule(self) -> None:
        ...
        for row in rows:
            if row["arm_id"] == CANDIDATE_ID and row["scenario_id"] == "E3.spike5x50ms":
                value = 10.0 if row["seed"] == "E916" else 0.9
