...
import scripts.reviewer_experiments.protocol.nse_e3_causal_horizon_training_reveal_v109 as reveal_module
from scripts.reviewer_experiments.protocol.nse_e3_causal_horizon_training_reveal_v109 import (
    ARMS,
    EXPECTED_SCENARIOS,
    EXPECTED_SEEDS,
...
class CausalHorizonRevealV109Tests(unittest.TestCase):
    ...
    def test_joint_gate_uses_frozen_shorter_horizon_tie_break(self) -> None:
        ...
        self.assertFalse(diagnostic["used_for_V109_selection"])
    ...
    def test_one_large_outlier_cannot_satisfy_two_of_three_rule(self) -> None:
        ...
        for row in rows:
            if (
                ...
                value = 10.0 if row["seed"] == "E898" else 0.9
