...
from scripts.reviewer_experiments.protocol.nse_e3_remaining_queue_work_training_blind_audit_v111 import (
    ...
    _validate_remaining_queue_work_diagnostics,
)
...
class RemainingQueueWorkBlindAuditV111Tests(unittest.TestCase):
    def test_frozen_arm_seed_and_runtime_boundary(self) -> None:
        self.assertEqual(TRAINING_SEEDS, {"E902", "E903", "E904"})
    ...
    def test_diagnostics_require_remaining_work_and_ratio_certificate(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
                        ...
                        "decision": {
                            "load_least_dominance_gate": {
                                ...
                                "critical_service_proxy": _critical(
                                    invoked, work_source=REMAINING_WORK_SOURCE
                                ),
                            }
                        },
                    }
            ...
            evidence = _validate_remaining_queue_work_diagnostics(
            ...
            self.assertEqual(evidence["work_source"], REMAINING_WORK_SOURCE)
    ...
    def test_diagnostics_reject_legacy_or_incomplete_remaining_work(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with self.assertRaisesRegex(
                RuntimeError, "remaining-work observation changed"
            ):
                _validate_remaining_queue_work_diagnostics(
