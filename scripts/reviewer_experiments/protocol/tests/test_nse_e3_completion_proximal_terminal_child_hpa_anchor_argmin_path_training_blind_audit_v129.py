...
def _critical(invoked: bool, *, work_source: str) -> dict:
    return {
        ...
        "terminal_child_path_pareto": {
            ...
            "compared_container_path_count": 1 if invoked else 0,
            "input_unavailable_count": 0,
            ...
            "comparison": "every_terminal_child_alternative_path_to_the_deterministic_anchor_argmin_hpa_container_less_than_or_equal_to_anchor",
            ...
            "container_pairing": "same_deterministic_anchor_argmin_child_container_node",
            "aggregation": "complete_per_child_pareto_on_deterministic_anchor_argmin_witness",
            "uses_completion_outcomes": False,
        },
...
class CompletionProximalBlindAuditV129Tests(unittest.TestCase):
    def test_frozen_arm_seed_and_runtime_boundary(self) -> None:
        self.assertEqual(TRAINING_SEEDS, {"E1310", "E1311", "E1312"})
        self.assertEqual(CONFIRMATION_SEEDS, [f"E{i}" for i in range(1313, 1333)])
        self.assertEqual(
            PREVIOUS_CONFIRMATION_SEEDS,
            [
    ...
    def test_diagnostics_require_admitted_snapshot_and_ratio_certificate(
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertEqual(
                evidence["terminal_child_path_compared_container_path_count"], 1
            )
            ...
            self.assertEqual(
                evidence["terminal_child_path_starting_container_count"], 0
            )
