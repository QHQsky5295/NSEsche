...
from scripts.reviewer_experiments.protocol.nse_e3_causal_horizon_training_blind_audit_v109 import (
    ...
    _validate_causal_horizon_diagnostics,
)
from scripts.reviewer_experiments.protocol.util import object_hash


class CausalHorizonBlindAuditV109Tests(unittest.TestCase):
    def test_frozen_arm_seed_density_and_runtime_boundary(self) -> None:
        self.assertEqual(TRAINING_SEEDS, {"E896", "E897", "E898"})
        ...
        self.assertEqual(CANONICAL_RENAME_RECEIPT, "canonical_rename_receipt_v109.json")
        self.assertEqual(
        ...
        self.assertEqual(
            {item["shock_activation_horizon_frames"] for item in ARMS.values()},
            {None, 25, 50},
        )
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            for frame in range(2):
                gate = {
                    ...
                    "active_frames": 25,
                    "until_frame": 25 if frame == 1 else None,
            ...
            evidence = _validate_causal_horizon_diagnostics(
                ...
                canonical,
                {
                    ...
                    "diagnostic_activation_horizon_frames": 25,
                },
            )
