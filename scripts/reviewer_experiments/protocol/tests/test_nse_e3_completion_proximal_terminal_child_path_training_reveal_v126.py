...
import scripts.reviewer_experiments.protocol.nse_e3_completion_proximal_terminal_child_path_training_reveal_v126 as reveal_module
from scripts.reviewer_experiments.protocol.nse_e3_completion_proximal_terminal_child_path_training_reveal_v126 import (
    ARMS,
    CANDIDATE_ID,
    EXPECTED_SCENARIOS,
    EXPECTED_SEEDS,
...
class CompletionProximalRevealV126Tests(unittest.TestCase):
    ...
    def test_single_candidate_must_pass_all_nine_frozen_gates(self) -> None:
        ...
        self.assertFalse(diagnostic["used_for_V126_selection"])
