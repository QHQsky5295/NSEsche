...
from scripts.reviewer_experiments.protocol.nse_e3_exact_queue_work_training_blind_audit_v110 import (
    ...
    _validate_exact_queue_work_diagnostics,
)
...
class ExactQueueWorkBlindAuditV110Tests(unittest.TestCase):
    def test_frozen_arm_seed_and_runtime_boundary(self) -> None:
        self.assertEqual(TRAINING_SEEDS, {"E899", "E900", "E901"})
    ...
    def test_diagnostics_require_exact_work_and_ratio_certificate(self) -> None:
                ...
                windows.append(
                    {
                        ...
                        "cluster": {
                            ...
                            "queue_runnable_cpu_work_total": 2.0,
                            "queue_runnable_cpu_work_max": 1.5,
                        ...
                        "decision": {
                            "load_least_dominance_gate": {
                                ...
                                "critical_service_proxy": _critical(
                                    invoked, work_source=EXACT_WORK_SOURCE
                                ),
                            }
                        },
                    }
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            event = {
                ...
                "cluster": {
                    ...
                    "queue_cpu_work_observation_complete": False,
                },
                "decision": {
                    "load_least_dominance_gate": {
                        "causal_arrival_shock": {
            ...
            with self.assertRaisesRegex(RuntimeError, "exact-work observation changed"):
                _validate_exact_queue_work_diagnostics(
