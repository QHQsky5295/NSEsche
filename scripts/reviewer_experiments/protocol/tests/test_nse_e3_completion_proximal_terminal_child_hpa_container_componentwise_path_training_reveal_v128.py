...
import scripts.reviewer_experiments.protocol.nse_e3_completion_proximal_terminal_child_hpa_container_componentwise_path_training_reveal_v128 as reveal_module
from scripts.reviewer_experiments.protocol.nse_e3_completion_proximal_terminal_child_hpa_container_componentwise_path_training_reveal_v128 import (
    ARMS,
    CANDIDATE_ID,
    EXPECTED_SCENARIOS,
    EXPECTED_SEEDS,
...
class CompletionProximalRevealV128Tests(unittest.TestCase):
    def test_reveal_is_locked_to_the_frozen_v128_joint_blind_audit(self) -> None:
        self.assertEqual(
        ...
        self.assertEqual(reveal_module.EXPECTED_SEEDS, ("E1287", "E1288", "E1289"))
    ...
    def test_single_candidate_must_pass_all_nine_frozen_gates(self) -> None:
        ...
        self.assertFalse(diagnostic["used_for_V128_selection"])
    ...
    def test_one_large_outlier_cannot_satisfy_two_of_three_rule(self) -> None:
        ...
        for row in rows:
            if row["arm_id"] == CANDIDATE_ID and row["scenario_id"] == "E3.spike5x50ms":
                value = 10.0 if row["seed"] == EXPECTED_SEEDS[-1] else 0.9
