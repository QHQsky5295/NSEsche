...
import scripts.reviewer_experiments.protocol.nse_e3_initializer_component_safety_training_reveal_v103 as reveal_module
from scripts.reviewer_experiments.protocol.nse_e3_initializer_component_safety_training_reveal_v103 import (
    ARMS,
    EXPECTED_SCENARIOS,
    EXPECTED_SEEDS,
...
class InitializerComponentSafetyRevealV103Tests(unittest.TestCase):
    ...
    def test_joint_gate_uses_frozen_componentwise_tie_break(self) -> None:
        ...
        self.assertFalse(diagnostic["used_for_V103_selection"])
    ...
    def test_one_large_outlier_cannot_satisfy_two_of_three_rule(self) -> None:
        ...
        for row in rows:
            if (
                ...
                value = 10.0 if row["seed"] == "E880" else 0.9
