...
import scripts.reviewer_experiments.protocol.nse_e3_completion_proximal_terminal_child_hpa_anchor_top2_path_training_reveal_v130 as reveal_module
from scripts.reviewer_experiments.protocol.nse_e3_completion_proximal_terminal_child_hpa_anchor_top2_path_training_reveal_v130 import (
    ARMS,
    CANDIDATE_ID,
    EXPECTED_SCENARIOS,
    EXPECTED_SEEDS,
...
class CompletionProximalRevealV130Tests(unittest.TestCase):
    def test_reveal_is_locked_to_the_v130_joint_blind_audit(self) -> None:
        self.assertEqual(
        ...
        self.assertEqual(reveal_module.EXPECTED_SEEDS, ("E1333", "E1334", "E1335"))
    ...
    def test_single_candidate_must_pass_all_nine_frozen_gates(self) -> None:
        ...
        self.assertFalse(diagnostic["used_for_V130_selection"])
