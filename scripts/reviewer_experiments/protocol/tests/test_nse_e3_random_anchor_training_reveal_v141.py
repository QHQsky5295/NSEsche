...
from scripts.reviewer_experiments.protocol import (
    nse_e3_random_anchor_training_reveal_v141 as reveal_v141,
)
...
from scripts.reviewer_experiments.protocol.nse_e3_random_anchor_training_reveal_v141 import (
    METRICS,
...
class RandomAnchorRevealV141Tests(unittest.TestCase):
    ...
    def test_reveal_is_bound_to_this_rounds_passing_blind_audit(self) -> None:
        self.assertIsNone(reveal_v141.BLIND_AUDIT_FILE_SHA256)
        self.assertIsNone(reveal_v141.BLIND_AUDIT_HASH)
        with self.assertRaisesRegex(RuntimeError, "not been frozen"):
            reveal_v141._validate_blind_audit()
