...
| V157 references | exact 3 state-matched references | PENDING | No baseline rebuild |
| V157 online diagnostic | exact 3 NSESche rows | PENDING | Blind audit before reveal |
| V157 decision | unchanged complete 20-seed hybrid gates | PENDING | Pass may open remaining 17; fail retires V157 |
