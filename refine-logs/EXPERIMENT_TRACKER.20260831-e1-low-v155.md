...
|---|---|---|---|---|---|---|---|---|
| CLN-01 | M0 | Lossless archive and disk cleanup | historical `nse_dev/tmp` | all retained history | SHA-256, CRC, bytes/files | MUST | RUNNING | No experiment may start before verified receipt |
| V155-PRE | M1 | Freeze queue-gated low mechanism | `srpt_ready_hiku2_ocs_queue8` | no online data | unit and blind-audit invariants | MUST | TODO | Threshold fixed at 8 tasks/node |
