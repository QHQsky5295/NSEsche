...
|---|---|---|---|
| 2026-09-05 | `P5_ONLINE_CORRECTED_QC_RESUME_PREREGISTRATION.md` | Freeze a fail-closed recovery control for a corrected historical QC signature without rewriting evidence | current; online execution blocked pending implementation audit |
