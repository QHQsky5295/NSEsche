...
| G3-DIAG | Decision-neutral mechanism diagnosis | PREREGISTERED / IN PROGRESS | 0 new runs | One falsifiable formula-consistent cause is declared before candidate design | Fixed D1--D5 decomposition and all 24 exploratory associations; Q61--Q80/G2 may be used only for mechanism diagnosis, not candidate effect estimation; D71 remains unopened; see `G3_MECHANISM_DIAGNOSIS_PREREGISTRATION.md` |
