...
| G0-FEEDBACK | Eq. (16)--(20) control-path observability | IMPLEMENTED / CORRECTED-RUNTIME REPLAY REQUIRED | 0 | Control gap, gamma, price multiplier and outer assignment trace revalidate exactly from real logs | commit `cafb7c5` separates per-round Eq. (16)/(19) control traces from final baseline empirical gap; Rust 31/31 and reviewer analysis 48/48 pass; no new seed captured; see `G0_OUTER_FEEDBACK_OBSERVABILITY_AUDIT.md` |
