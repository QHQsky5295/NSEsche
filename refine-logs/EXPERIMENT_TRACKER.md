...
| M1-QUAL | Six-cell method qualification | FAILED GATE / DIAGNOSIS | 90/90 screen; 1200/1200 qualification canonical; 0/30 diagnostic | Development throughput/QPR gates pass | All paired rows retained and audited; `ready_order` failed the dual-first gate in 6/6 cells; decision-neutral diagnosis preregistered in `M1_MECHANISM_DIAGNOSIS_PLAN.md`; no M2 run authorized |
